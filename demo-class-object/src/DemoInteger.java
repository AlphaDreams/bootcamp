public class DemoInteger {
  public static void main(String[] args) {
    ...
    Integer x2 = 3;
    System.out.println(x == x2); //true, same object 

    Integer x3 = new Integer(3);
    System.out.println(x == x3); //false , different object

    Integer x4 = Integer.valueOf(3);
    System.out.println(x == x4); // true, same object

    Integer y3 = Integer.valueOf(128);
    System.out.println(y2 == y3); //false , different object, out of range 
